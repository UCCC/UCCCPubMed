<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="ProgramPublicationStat.aspx.cs" Inherits="ProgramPublicationStat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="body">
            ...
            <Columns> 
                <asp:HyperLinkField    
                    HeaderText="Program"  
                    DataNavigateUrlFields="l_program_id"  
                    DataNavigateUrlFormatString="~/PublicationsOfOneProgram.aspx?programId={0}"
