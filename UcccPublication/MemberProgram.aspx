<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="MemberProgram.aspx.cs" Inherits="MemberProgram" %>
    ...
    <div id="body">
            <div class="fullblock" id="inventoryDiv" runat="server" style="text-align:center">
                ...
                <asp:datagrid id="myDatagrid" runat="server" Font-Size="X-Small" 
					...
					<Columns>
						<asp:BoundColumn Visible="False" DataField="client_program_id" ReadOnly="True" HeaderText="client_program_id"></asp:BoundColumn>
						<asp:TemplateColumn ItemStyle-Width="200px" HeaderText="Program">
							<ItemTemplate>
								<asp:Label id="lblOrigProgram" Width="180px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.program") %>'>
								</asp:Label>
							</ItemTemplate>
							<EditItemTemplate>
								<asp:DropDownList id="ddlProgram" DataValueField="l_program_id" DataTextField="program" Width="180px"
									runat="server"></asp:DropDownList>
							</EditItemTemplate>
							<FooterTemplate>
								<asp:DropDownList id="ddlAddNewProgram" DataValueField="l_program_id" DataTextField="program" Width="180px"
									runat="server"></asp:DropDownList>
							</FooterTemplate>
