<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="CrossProgramPubByMember.aspx.cs" Inherits="CrossProgramPubByMember" %>
    ...
    <div id="body">
            <div class="fullblock" id="inventoryDiv" runat="server">
                <font color="maroon" size="2" style="font-weight:bold">
                    Member Cross Program Publications<br />
            </font>
            <div  class="inventorycrumbs">
                ...
                <asp:DropDownList ID="ddlMember" runat="server" Width="200px">
                </asp:DropDownList>
                <div><br />
